...
$query = "insert into wpw1_cwa_assessment_log 
			...
			values ('$inpVariable','$thisdate','faketestapi')";
// echo "$query\n";			
...
(callsign, level, cpm, eff, freq, questions, words, characters, score,details,date_written) 
values ('$callsign','$level',$cpm,$eff,'$freq',$questions,$words,$characters,$score,'$details','$thisdate')";
