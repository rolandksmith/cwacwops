...
///// all processing done. Prepare totals	
		...
		$token			= mt_rand();
		$reminder_text	= "<b>Daily Advisor Cron</b> To view the Daily Advisor Cron report for $nowDate $nowTime, click <a href='$siteURL/cwa-display-saved-report/?strpass=3&inp_callsign=WR7Q&inp_id=$reportid&token=$token' target='_blank'>Display Report</a>";
